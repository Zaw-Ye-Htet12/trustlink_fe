...
const adminMenuItems = [
  ...
  { title: "Agents Management", href: "/admin/agents", icon: UserCheck },
  {
          ...
          <div className="flex flex-col flex-1 min-h-0 border-r bg-white">
            <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
              <div className="flex items-center flex-shrink-0 px-6 mb-8">
                <div className="w-8 h-8 bg-gradient-to-br from-red-600 to-orange-500 rounded-lg flex items-center justify-center shadow-lg">
                  <Shield className="h-4 w-4 text-white" />
                </div>
                <span className="ml-2 font-bold text-lg bg-gradient-to-br from-red-600 to-orange-500 bg-clip-text text-transparent">
                  Admin Panel
                </span>
              </div>
